...
describe("Teste para a home", () => {
  ...
  it("Deve incluir informações no formulário", () => {
    cy.get('input[type="text"]').type("Danillo Guimarães"); // Preencher o campo de nome
    cy.get('input[type="email"]').type("danillo.lgm@gmail.com"); // Preencher o campo de e-mail
    cy.get('input[type="tel"]').type("13912345678"); // Preencher o campo de telefone
